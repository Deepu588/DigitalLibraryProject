...
<div class="col-md-8  text-light p-3 cc"   style="background-image:linear-gradient(to top left,rgba(0,0,0,0.7),rgba(0,0,0,0.6),rgba(0,0,0,0.7),rgba(0,0,0,0.6),rgba(0,0,0,0.5),rgba(0,0,0,0.6));position:absolute;left:15%;top:20%;border-bottom-style:solid;border-right-style:solid;border-color:white;">
